...
NEW_ABBR="LDD_OPERATIONS_"
NEW_BASE="ldd-operations"
NEW_CLASS="LDD_Operations"
NEW_FILTER="${NEW_ABBR,,}"
NEW_KB_PATH=""
NEW_SITE="https://github.com/michael-cannon/${NEW_BASE}"
NEW_SITE=
NEW_SLUG="${NEW_FILTER}"
NEW_SLUG_LONG="${NEW_BASE/-/_}"
NEW_TITLE="Legal Document Deliveries - Operations"
NEW_TITLE_SHORT="LDD Operations"

OLD_ABBR="LDD_ORDERING_"
OLD_BASE="ldd-ordering"
OLD_CLASS="LDD_Ordering"
OLD_FILTER="${OLD_ABBR,,}"
OLD_KB_PATH=""
OLD_SITE="https://github.com/michael-cannon/${OLD_BASE}"
OLD_SLUG="${OLD_FILTER}"
OLD_SLUG_LONG="${OLD_BASE/-/_}"
OLD_TITLE="Legal Document Deliveries - Ordering"
OLD_TITLE_SHORT="LDD Ordering"
